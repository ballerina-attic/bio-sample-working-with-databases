...
def main():
    ...
    with open('src/scripts/working_with_databases.bal', 'r') as action_obj:
        action_bbe = action_obj.readlines()

    old_text = soup.find('div', {'id':'working_with_databases'})
    ...
    try:
        update = commit_file('index.html', updated_file, 'update-working-with-databases', commit_message)[0]
